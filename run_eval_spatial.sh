...
#SBATCH --mem=64G
#SBATCH --time=8:00:00
#SBATCH --job-name="scenecot_eval_spatial"
#SBATCH -p gpu
#SBATCH --gres=gpu:1
#SBATCH --output=eval_spatial_output_%j.txt
...
# Point the MSQA annotations at the spatial stress-test slice
# (directory prepared by generate_spatial_test_slice.py + symlinks; see README of the slice dir)
export SCENECOT_MSR3D_ANNO_DIR=~/EE243_Scenecot_Project/data_assets/msqa_spatial_slice
